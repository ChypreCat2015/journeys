        ...
        <header class="jumbotron">
            <div class="container">
                <h1 class="display-4 headline">
                    Welcome to My Wonderful Journeys!
                </h1>
                <p class="lead">View places I've been to</p>
                <div class="search">
                    <router-link :to="{ name: 'AddJourney' }" class="btn btn-lg"
                        >Add New Journey</router-link
                    >
                    <input
                        type="text"
                        v-model="search"
                ...
                >
                    <div id="indexcard" class="card mt-3">
                        ...
                        <div class="card-body d-flex flex-row flex-wrap">
                            ...
                            <small class="card-text text-muted w-100">{{
                                journey.description | snippet
                            }}</small>
