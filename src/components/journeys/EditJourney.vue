    ...
    <div v-if="journey" id="editjourney" class="container">
        ...
        <form @submit.prevent="editJourney"> 
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="15" name="des" v-model="journey.description"></textarea>
            </div>
            <div class="form-group">
...
export default {
    ...
    methods: {
         editJourney(){ 
            if(this.journey.title && this.journey.location && this.journey.image && this.journey.description){
            this.feedback = null;
            //create slug
            ...
            db.collection('journeys').doc(this.journey.id).update({
            ...
            // console.log('this is edit finish')
        } else {
            this.feedback = "Please fill all the information"
            console.log(this.journey.title)
        }
    ...
    created(){
        let ref = db.collection('journeys').where('slug', '==', this.$route.params.journey_slug);
